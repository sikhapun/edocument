...
4.  ในกรณีเป็นการอัปเกรด สามารถนำไฟล์ทั้งหมดไปแทนที่ไฟล์เดิม ยกเว้นไดเร็คทอรี่ install/ เสร็จแล้วเข้าไปยังฐานข้อมูล (ด้วย phpMyAdmin หรือโปรแกรมจัดการฐานข้อมูลที่ใช้งานอยู่) ทำการเปลี่ยนชื่อคอลัมน์ `fb` ของตาราง `xxx_user` (xxx คือ prefix ของฐานข้อมูล) ให้เป็นชื่อ `social`
